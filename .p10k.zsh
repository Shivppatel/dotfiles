# Generated by Powerlevel10k configuration wizard on 2025-05-30 at 00:32 EDT.
...
() {
  ...
  # TokyoNight Night prompt accents.
  ...
  typeset -g POWERLEVEL9K_MULTILINE_FIRST_PROMPT_SUFFIX='%F{#565f89}─╮'
  typeset -g POWERLEVEL9K_MULTILINE_NEWLINE_PROMPT_SUFFIX='%F{#565f89}─┤'
  typeset -g POWERLEVEL9K_MULTILINE_LAST_PROMPT_SUFFIX='%F{#565f89}─╯'
  ...
  typeset -g POWERLEVEL9K_ASDF_FOREGROUND='#7dcfff'
  typeset -g POWERLEVEL9K_{VIRTUALENV,ANACONDA,PYENV,GOENV,GO_VERSION,RUST_VERSION}_FOREGROUND='#7dcfff'
  typeset -g POWERLEVEL9K_{NODENV,NVM,NODEENV,NODE_VERSION}_FOREGROUND='#9ece6a'
  typeset -g POWERLEVEL9K_{JENV,JAVA_VERSION,ASDF_JAVA}_FOREGROUND='#e0af68'
  typeset -g POWERLEVEL9K_KUBECONTEXT_DEFAULT_FOREGROUND='#bb9af7'
  typeset -g POWERLEVEL9K_TERRAFORM_OTHER_FOREGROUND='#7dcfff'
  typeset -g POWERLEVEL9K_TERRAFORM_VERSION_FOREGROUND='#7dcfff'
  typeset -g POWERLEVEL9K_AWS_DEFAULT_FOREGROUND='#ff9e64'
  typeset -g POWERLEVEL9K_AZURE_OTHER_FOREGROUND='#7aa2f7'
